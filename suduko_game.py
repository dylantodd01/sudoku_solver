...
class Suduko:
    ...
    def __init__(self):
        """ Initialise the suduko grid, GUI class and some basic Suduko class variables """
    ...
    def output_board(self):
        """ Outputs the board to the command window, a faster alternative to using the GUI """
